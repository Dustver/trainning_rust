...
// мы должны вызвать &mut self. В редких случаях может понадобиться получить владение
// self, т.к. это может понадобиться лишь для трансформации экземпляра во что-то другое.
    fn area(&self) -> u32 {
